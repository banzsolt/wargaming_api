...
module WargamingApi
  class WargamingApi::WorldOfTanks::GlobalMap
    class WargamingApi::WorldOfTanks::GlobalMap::AccountsSeasonData < WargamingApi::WorldOfTanks::GlobalMap
      ...
      def set_vehicle_level(value)
        if WargamingApi::WorldOfTanks::GlobalMap::AccountsSeasonData.possible_vehicle_level.include? value
          @vehicle_level = value
        else
          @vehicle_level = '6,8,10'
        end
      ...
      puts 'WorldOfTanks => GlobalMap -> AccountsSeasonData loaded.'
    end
  end
end